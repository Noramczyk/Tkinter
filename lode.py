...
def importFile():
    ...
    main_screen.title('File Explorer')                               # Window Title
    main_screen.geometry("500x500")                                      
    main_screen.config(background = "white")                         # Set window background color
    fileExplorer = Label(main_screen, 
                                text = "File Explorer ",
                                width = 100, height = 4, 
                                fg = "blue")     
          
    buttonExplore = Button(main_screen, 
                            text = "Browse Files",
                            command = browseFiles)              # Command call for browseFile function
      
    buttonExit = Button(main_screen, 
                         text = "Exit",
                         command = exit) 
